...
""" This function returns the features in a dataframe for a given cluster. """
...
file_dt_rmse = open("decision_tree_rmse_final_features_fast.txt", "w")
file_dt_r2 = open("decision_tree_r2_final_features_fast.txt", "w")
file_lr_rmse = open("linear_regression_rmse_final_features_fast.txt", "w")
file_lr_r2 = open("linear_regression_r2_final_features_fast.txt", "w")
...
for errorIndex in range(N_OF_CLUSTERS):
    ...
    file_lr_rmse.write("RMSE for cluster " + str(errorIndex) + " is " + str([errorIndex]) + "\n")
