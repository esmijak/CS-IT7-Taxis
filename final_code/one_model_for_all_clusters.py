""" This script compute the linear regression and decision tree models for one model for all cluster. """
from schemas import *
...
""" This function returns the features values of a current features row entrie. """
...
def main():
    ...
    # Computes the error per cluster to be able to compare them with one model per cluster: 
    for cid in range(N_OF_CLUSTERS):
    ...
    return  errorsRMSE_LR, errorsR2_LR, errorsRMSE_DT, errorsR2_DT

errorsRMSE_LR, errorsR2_LR, errorsRMSE_DT, errorsR2_DT = main()


""" This function writes the computed errors in several files """
